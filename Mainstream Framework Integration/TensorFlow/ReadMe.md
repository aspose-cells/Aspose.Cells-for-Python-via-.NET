...
-   A table showing **X values (10--19)** and **predicted Y values**
-   A **line chart** visualizing the predictions
-   Chart title: **Predicted y = 2x + 1**
...
Running the script produces:
    ...
    tensorflow_prediction.xlsx

Open the file to view the prediction results and generated chart.
