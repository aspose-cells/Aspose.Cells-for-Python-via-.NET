...
def run_autofilter_not_contains():
    ...
    worksheet.auto_filter.custom(0, cells.FilterOperatorType.NOT_CONTAINS, "Be")
    worksheet.auto_filter.refresh()

    output_path = os.path.join(output_dir, "outSourseSampleCountryNames.xlsx")
    workbook.save(output_path)

    print("AutofilterNotContains executed successfully.")

if __name__ == "__main__":
    run_autofilter_not_contains()